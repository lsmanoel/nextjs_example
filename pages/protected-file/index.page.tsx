          ...
          <main className={styles.main}>
            ...
            <div className={styles.column}>
              ...
              <h3>
                ...
                . Logo sem a efetuação do Login esse conteúdo jamais seria
                mandado para o navegador do cliente. Essa página serve como
                demonstração desse recurso. Como você efetuou o login, você
                recebeu acesso ao conteúdo secreto e protegido:
              </h3>
            </div>
            <div>
